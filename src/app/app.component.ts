...
export class AppComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.titleService.setTitle("Lucas Melo | Full Stack Developer");

    this.metaService.addTags([
      { name: 'keywords', content: 'Full Stack, software, developer' },
      {
        "name": "description",
        "content": "Com 6 anos de experiência desenvolvendo sistemas, interfaces, bots e soluções tecnológicas para tornar a web um lugar melhor. No meu trabalho, gosto de liderar, propor e executar ideias, escrever e refatorar código limpo, reutilizável e escalável."
      }
    ]);
